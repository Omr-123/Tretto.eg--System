...
VALUES
('Rose Pink Clog Soft', 299.99, 'Stylish rose pink clogs', 'Clog', 0, 1),
('Black Crossbody Bag', 499.99, 'Elegant black bag', 'Bag', 0, 2),
('Black Slipper', 199.99, 'Soft cozy slippers', 'Slipper', 0, 1);
...
INSERT INTO product_variants (PID, color, stock, add_price, sizes)
VALUES
(1, '#7BA7BC', 30, 100.00, 38),
(2, '#000000', 30, 0.00, 30),
(3, '#050505', 100, 0.00, 36);
...
INSERT INTO product_images (pvid, images)
VALUES
(1, 'assets/images/rose1.png'),
(1, 'assets/images/rose2.png'),
(2, 'assets/images/bag1.png'),
(3, 'assets/images/slipper1.png'),
(3, 'assets/images/slipper2.png');
...
VALUES
(1, 899.98, 'Delivered', 'Cairo Street', '2026-05-01', 'Cash'),
(2, 199.99, 'Processing', 'Giza Street', '2026-05-22', 'Visa'),
(2, 299.99, 'Pending', 'Giza Street', NULL, 'Cash');
...
-- ================================================
-- EXCHANGE REQUESTS (refund / exchange form)
-- ================================================
CREATE TABLE exchange_requests (
    ...
    request_type ENUM('refund', 'exchange') NOT NULL,
    reason VARCHAR(255) NOT NULL,
    details TEXT NOT NULL,
    preferred_size VARCHAR(20) DEFAULT NULL,
    preferred_color VARCHAR(50) DEFAULT NULL,
    contact_method VARCHAR(20) NOT NULL,
    status ENUM('pending', 'approved', 'rejected') NOT NULL DEFAULT 'pending',
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_er_order (order_id),
    INDEX idx_er_user (user_id),
    CONSTRAINT fk_er_order FOREIGN KEY (order_id) REFERENCES orders(orderID) ON DELETE CASCADE,
    CONSTRAINT fk_er_user FOREIGN KEY (user_id) REFERENCES users(userID) ON DELETE CASCADE,
    CONSTRAINT fk_er_old_product FOREIGN KEY (old_product_id) REFERENCES product(PID),
    CONSTRAINT fk_er_new_product FOREIGN KEY (new_product_id) REFERENCES product(PID) ON DELETE SET NULL
) ENGINE=InnoDB;
