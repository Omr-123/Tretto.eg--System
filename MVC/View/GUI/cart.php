            ...
            <div class="cart-layout">
                            ...
                            <div class="ci-inf">
                                ...
                                <form method="GET" action="cart.php">
                                    ...
                                    <div class="ci-qty">
                                        ...
                                        <button class="btn-ghost" type="submit" name="action" value="remove"
                                            style="margin-left:8px;font-size:11px;color:var(--rose)">Remove</button>
                                    </div>
                                </form>
                            </div>

                            <div class="ci-pr">
                                <?= $cartController->getPrice($item->price, ($item->variants[$cart_info[$ct]['pvid'] - 1]->add_price ?? 0), $cart_info[$ct]['quantity']); ?>
                                EGP</div>
                        </div>
                    <?php endforeach; ?>
                ...
                <div class="cart-summary">
                    ...
                    <button class="btn-primary" style="width: 100%; margin-bottom: 10px;"
                        onclick="window.location.href='/Tretto.eg--System/MVC/View/GUI/checkout.php'">Proceed
                        to Checkout 💕</button>
                    <button class="btn-secondary" style="width: 100%;"
                        onclick="window.location.href='/Tretto.eg--System/MVC/View/GUI/product.php'">Continue
                        Shopping</button>
                </div>
            </div>
        </div>
