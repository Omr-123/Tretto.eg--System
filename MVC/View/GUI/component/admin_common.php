...
function admin_header(string $title = 'Admin', string $active = ''): void
{
    ...
    <body>
        ...
        <div class="layout">
            <aside class="sidebar">
                <div class="logo">Tretto<span>.</span>eg</div>
                <div class="sub">Admin Dashboard</div>
                <div class="nav-title">Overview</div><a class="nav-item <?= $active === 'dashboard' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_dashboard.php#dashboard')) ?>">🏠 Dashboard</a>
                <div class="nav-title">Products</div><a class="nav-item <?= $active === 'products' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_dashboard.php#products')) ?>">👟 Products</a><a
                    class="nav-item <?= $active === 'add-product' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_dashboard.php#add-product')) ?>">➕ Add Product</a>
                <div class="nav-title">Orders</div><a class="nav-item <?= $active === 'orders' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_dashboard.php#orders')) ?>">📦 Orders</a><a
                    class="nav-item <?= $active === 'refunds' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_dashboard.php#refunds')) ?>">🔄 Refunds</a><a
                    class="nav-item <?= $active === 'reports' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_dashboard.php#reports')) ?>">📊 Reports</a>
                <div class="nav-title">More</div><a class="nav-item <?= $active === 'reviews' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_reviews.php')) ?>">⭐ Reviews</a><a
                    class="nav-item <?= $active === 'exchanges' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_exchanges.php')) ?>">🔁 Exchanges</a><a
                    class="nav-item <?= $active === 'locations' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_locations.php')) ?>">📍 Locations</a><a
                    class="nav-item <?= $active === 'support' ? 'active' : '' ?>"
                    href="<?= h(app_url('MVC/View/GUI/component/admin_support.php')) ?>">🎧 Support</a>
                <div class="side-footer"><strong><?= h($adminName) ?></strong>
                    <div class="muted">Full Access</div>
                    <form method="POST" action="<?= h(app_url('MVC/Controller/AuthController.php')) ?>"
